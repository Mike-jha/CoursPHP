...
class ArticleManager extends AbstractManager
{
    ...
    public function findAll()
    {
        ...
        // Deuxieme paramètre indique quelle classe PDO doit utiliser
        // Article::class retourne une chaine contenent le nom de la classe avec son espace de nom ("Entity\Article")
