...
/*
    ...
    - Quand on appelera cette méthode, le programme affichera ("Il vous rest XXX cl de café.")
*/
$myCoffee->sip(3);
$myCoffee->sip(7);

/*
    - refill (remplir la tasse): Elle n'acceptera pas de paramètre et se contentera de remplir la tasse à son niveau max (20)
...
/*
    ...
    - Modifier la méthode refill pour remplir la tasse de sont volume
*/
