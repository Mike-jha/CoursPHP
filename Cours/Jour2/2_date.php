...
date_default_timezone_set('Europe/Paris'); // Modifie le fuseau horraire
echo 'Nous sommes le '.date('d/m/Y');
echo '<br/>';
echo 'Date avec heure '.date('d/m/Y H i s');
echo '<br/>';
echo "Il s'est éccoulé ".time().' secondes depuis le 1 janvier 1970';
...
/*
En SQL les dates sont stockées dans une chaine au format 'm-d-Y'
*/
echo '<br/>';
$dateDB = '13-02-2013';
echo date('d/m/Y', date_create($dateDB)); // retourne un objet DateTime
...
// fonctionne aussi pour les objets DateTime 
